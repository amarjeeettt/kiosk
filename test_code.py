...
class PrintFormWidget(QWidget):
    ...
    def setup_ui(self, title, num_copy, num_pages, total):
        ...
        # Start listening for coin slot events
        self.listen_for_coins()
    ...
    async def coin_slot_event_handler(self):
        while True:
    ...
    def listen_for_coins(self):
        ...
        asyncio.create_task(self.coin_slot_event_handler())
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.print_form_widget = PrintFormWidget(self, "Title", 1, 10, 100)

        self.layout = QVBoxLayout(self)
        self.layout.addWidget(self.print_form_widget)
