...
class HomeScreenWindow(QMainWindow):
    def __init__(self):
        ...
        label = QLabel("Pay-per Print: Lorem ipsum dolor sit amet", alignment=Qt.AlignCenter)
        label.setFont(QFont("Montserrat", 64, weight=QFont.Bold))
        label.setWordWrap(True)
        label.setStyleSheet("color: #D8C995; padding-top: 450px; letter-spacing: 4px; ")  # Adding stylesheet
        layout.addWidget(label, alignment=Qt.AlignVCenter)  # Align label vertically center
        ...
        layout.addWidget(sub_label, alignment=Qt.AlignVCenter)  # Align label vertically center
        ...
        admin_bt.setStyleSheet("QPushButton {background-color: transparent; border: none; image: url('img/admin_bt.svg');}"
